...
# === Класс AnimatedNPC (минимизированная версия) ===
class AnimatedNPC:
...
app = Ursina(title="NPC Test", borderless=False, vsync=False)
...
player = FirstPersonController(speed=8, jump_height=2, gravity=1, position=(20, 0, 0))
